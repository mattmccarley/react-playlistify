...
class Search extends React.Component {
  ...
  render() {
    return (
      <div className="absolute pin bg-grey-lightest pt-8">
        <div className="container mx-auto flex mb-12 flex items-center">
          <SearchBox handleSearch={this.handleSearch} />
          <button 
            className="ml-4 bg-purple-darker text-white w-10 h-10 rounded-full shadow-md flex flex-col justify-center items-center"
